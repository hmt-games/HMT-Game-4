...
namespace ErikDraft {
    ...
    public class PlantConfig : ScriptableObject {
        ...
        /// </summary>
        public float[] capacities = new float[System.Enum.GetValues(typeof(CompoundType)).Length];
        /// <summary>
        ...
        /// </summary>
        public float[] uptakeRate = new float[System.Enum.GetValues(typeof(CompoundType)).Length];
        /// <summary>
        /// The rate at which the plant can leech each compound back into the soil
        /// This is a percentage in the range 0 to 1
        /// </summary>
        public float[] leechRate = new float[System.Enum.GetValues(typeof(CompoundType)).Length];
        
        /// <summary>
        /// The amount of each compound per tick needed to maintain the plant's health
        /// </summary>
        public float[] metabolismNeeds = new float[System.Enum.GetValues(typeof(CompoundType)).Length];


        /// <summary>
        /// The amount each compound contributes to the plant's metabolism
        /// </summary>
       public float[] metabolismFactor = new float[System.Enum.GetValues(typeof(CompoundType)).Length];

        /// <summary>
        /// The amount pulled from the plant's reserves to grow
        /// This is a real value used in a clamp function
        public float[] growthConsumptionRateLimit = new float[System.Enum.GetValues(typeof(CompoundType)).Length];
        
        /// <summary>
        /// The coefficients for the effect of each compound on the plant's growth if they are negtaive they inhibit growth
        /// This is a real value
        /// </summary>
        public float[] growthFactor = new float[System.Enum.GetValues(typeof(CompoundType)).Length];
    ...
    public class SoilConfig: ScriptableObject {
        ...
        public float[] compoundCapacities = new float[System.Enum.GetValues(typeof(CompoundType)).Length];
    }
}
